...
*/
    public void updateLogger (Integer id,String userMail,String type, String category,String device,String message,String estatus) {

        updateLogger (id, userMail, type,  category, device, message, estatus, new Date());
    }



    public void updateLogger (Integer id,String userMail,String type, String category,String device,String message,String estatus,Date date) {
         ...
         values.put( LoggerEntry.DATE, this.dateFormat.format(date));
     ...
     /*
    public int depureLogger (String estatus) {
...
*/
    ...
    public void insertLogger(String userMail, String type, String category, String device ,String message,String estatus,Date date) {
        ContentValues values = new ContentValues();
    ...
    public void insertLogger(String userMail, String type, String category, String device ,String message,String estatus) {
       ...
       insertLogger( userMail,  type,  category,  device , message, estatus, new Date());
