...
*/
    public void addPhoto(Integer addressId,Integer clientId,String name,String path,String note,String estatus) {
        ...
        values.put(ImagesEntry.STATUS, estatus);
    ...
    public int updatePhoto(Integer id,String estatus,Date date) {
        ...
        ContentValues values = new ContentValues();
        values.put(ImagesEntry.STATUS, estatus);
        values.put(ImagesEntry.DATE, this.dateFormat.format(date));
