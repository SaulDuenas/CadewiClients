...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,LocationListener {
    ...
    public static final int MODE_VISOR=2;
    ...
    private void operationMode(Integer operation) {

        LatLng lat=null;
        String title="";
        btnRegister.setVisibility( View.INVISIBLE );

        if (operation.equals(MODE_REGISTER)) {
        ...
        else if (operation.equals(MODE_VISOR)) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPosition=datos.getInt("position");
        mPositionMode=datos.getInt("OperationMode");

        mclientItem =  ClientContent.focusClientItem;
        mAddressItem = mclientItem.Address.ITEMS.get( mPosition ); // Get AddressId
    ...
    @SuppressLint("RestrictedApi")
    private void ext_create() {

        TextView lblTitle = (TextView) findViewById( R.id.lblClient );
        lblTitle.setText("Cliente: " + mclientItem.name );
    ...
    private void activeProviders() {
        ...
        if (!this.isFinishing()) {
            ...
            builder.setMessage("CadewiClients necesita acceder a tu ubicación. Activa los serrvicios de Ubicación.")
                    .setCancelable(false)
